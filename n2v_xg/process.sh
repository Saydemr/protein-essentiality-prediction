                        ...
                        do
                            ...
                            do
                                ...
                                if [ -f $FILE ]; then
                                    ...
                                    emb_filename="csv_imp/${organism}_ppi_emb_d${dim}_e${epochs}_l${length}_w${walk}_k${cont}_p${retpar}_q${inout}.emb.csv"
                                    es_filename="csv_imp/${organism}_ppi_emb_d${dim}_e${epochs}_l${length}_w${walk}_k${cont}_p${retpar}_q${inout}.emb_out.csv"
